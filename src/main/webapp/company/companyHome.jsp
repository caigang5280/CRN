	...
	<body>
				  ...
				  <div class="container-fluid">
				    ...
				    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					  ...
					  <ul class="nav navbar-nav">
						 ...
						 <!-- 跳转至首页 -->
				        <li class="active"><a href="companyHome.html">首页 <span class="sr-only">(current)</span></a></li>
						<!-- 跳转至人才搜索与邀请 -->
				        <li><a href="companySearchInvitation.html">人才搜索与邀请</a></li>
						<!-- 查看简历 -->
						<li><a href="companyViewResume.html">查看简历</a></li>
				      </ul>
					  
				      <ul class="nav navbar-nav navbar-right">
						<!-- 发布招聘信息 -->
						<li><a href="companyReleaseInfo.html">发布招聘信息</a></li>
						<!-- 企业用户名 -->
				        <li class="dropdown">
				          ...
				          <ul class="dropdown-menu">
				            <li><a href="companyInfo.html">修改公司信息</a></li>
				            <li role="separator" class="divider"></li>
				            <li><a href="companyLoginRegister.html">退出账号</a></li>
				          </ul>
				        </li>
				      </ul>
				    </div><!-- /.navbar-collapse -->
		...
		<div class="container">
			<div class="row" style="text-align: center;" >
				...
				<div class="container">
					<div class="row" style="text-align: center;">
						<span>热门职位:</span>
						<a id="searchhotposition" href="#">Java</a>
						<a id="searchhotposition" href="#">产品经理</a>
						<a id="searchhotposition" href="#">Web前端</a>
						<a id="searchhotposition" href="#">项目经理/主管</a>
						<a id="searchhotposition" href="#">C++</a>
						<a id="searchhotposition" href="#">测试工程师</a>
						<a id="searchhotposition" href="#">数据分析师</a>
						<a id="searchhotposition" href="#">运维工程师</a>
					</div>
				</div>
		...
		<!-- 		<div class="container">
				        ...
				        <div class="col-md-offset col-md-12">
				            <div class="tab" role="tabpanel">
				                ...
				                <ul class="nav nav-tabs" role="tablist">
									<!-- 为你推荐 -->
				                    <li role="presentation" class="active"><a href="#Section1" aria-controls="home" role="tab" data-toggle="tab">为你推荐</a></li>
									<!-- 热门职位 -->
				                    <li role="presentation"><a href="#Section2" aria-controls="profile" role="tab" data-toggle="tab">热门职位</a></li>
									<!-- 我要入职 -->
				                    <li role="presentation"><a href="#Section3" aria-controls="messages" role="tab" data-toggle="tab">我要入职</a></li>
				                </ul>
								
				                <div class="tab-content tabs">
									<!-- 为你推荐 -->
				                    <div role="tabpanel" class="tab-pane fade in active" id="Section1"style="margin-left: 15px;margin-right: 15px;">
										<div class="row">
										<!-- 小米 -->
										<div class="col-md-4" style="background-color: white;" >
											...
											<div>&nbsp;&nbsp;&nbsp;
											<img src="img/xiaomiLogo.jpg" id="recommendimg" />
										...
										<div class="col-md-4" style="background-color: white;" >
											...
											<div>&nbsp;&nbsp;&nbsp;
											<img src="img/mayijinfuLogo.jpg" id="recommendimg" />
										...
										<div class="col-md-4" style="background-color: white;" >
											...
											<div>&nbsp;&nbsp;&nbsp;
											<img src="img/zhongguoyidongLogo.jpg" id="recommendimg" />
										...
										<div class="row">
											...
											<div class="col-md-4" style="background-color: white;" >
												...
												<div>&nbsp;&nbsp;&nbsp;
												<img src="img/ankerLogo.jpg" id="recommendimg" />
											...
											<div class="col-md-4" style="background-color: white;" >
												...
												<div>&nbsp;&nbsp;&nbsp;
												<img src="img/didiLogo.png" id="recommendimg" />
											...
											<div class="col-md-4" style="background-color: white;" >
												...
												<div>&nbsp;&nbsp;&nbsp;
												<img src="img/tengxunLogo.jpg" id="recommendimg" />
									...
									<!-- 热门职位 -->
				                    <div role="tabpanel" class="tab-pane fade" id="Section2"style="margin-left: 15px;margin-right: 15px;">
										<div class="row">
									<!-- 小米 -->
									<div class="col-md-4" style="background-color: white;" >
										<br />
									...
									<!-- 我要入职 -->
									<div role="tabpanel" class="tab-pane fade" id="Section3"style="margin-left: 15px;margin-right: 15px;">
				                       	<div class="row">
				                       	<!-- 小米 -->
				                       	<div class="col-md-4" style="background-color: white;" >
				                       		<br />
				...
				<div class="container" style="text-align: center;">
					<br />
				<button id="selectmore"style="width: 300px;height: 40px;background-color: white;text-align: center;" href="#"  >查看更多</a>
				</div>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="row" style="text-align: center;">
								<div class="col-md-3">
									<div>
									<img src="img/huaweiLogo.jpg" id="hotimg" />
									</div>
									<h4>华为</h4>
									<h6 style="color: gray;">科技 | 热门</h7>
									<div>
									<br />
									<button type="button" id="hotbtn"/>531个热招职位
									</div>
								</div>
								<div class="col-md-3" >
									<div>
									<img src="img/keeplogo.png" id="hotimg" />
									</div>
									<h4>Keep</h4>
									<h6 style="color: gray;">互联网 | 健身</h7>
									<div>
									<br/>
									<button type="button" id="hotbtn"/>431个热招职位
									</div>
								</div>
								<div class="col-md-3" >
									<div>
									<img src="img/weilaiLogo.png" id="hotimg" />
									</div>
									<h4>蔚来汽车</h4>
									<h6 style="color: gray;">科技 | 汽车</h7>
									<div>
									<br/>
									<button type="button" id="hotbtn"/>331个热招职位
									</div>
								</div>
								<div class="col-md-3">
									<div>
									<img src="img/xiaomiLogo.jpg" id="hotimg" />
									</div>
									<h4>小米科技</h4>
									<h6 style="color: gray;">科技 | 小米生态</h7>
									<div>
									<br/>
									<button type="button" id="hotbtn"/>831个热招职位
									</div>
								</div>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="row" style="text-align: center;">
								<div class="col-md-3">
									<div>
									<img src="img/kuaishouLogo.jpg" id="hotimg" />
									</div>
									<h4>快手</h4>
									<h6 style="color: gray;">科技 | 短视频</h7>
									<div>
									<br/>
									<button type="button" id="hotbtn"/>231个热招职位
									</div>
								</div>
								<div class="col-md-3">
									<div>
									<img src="img/wanmeishijieLogo.png" id="hotimg" />
									</div>
									<h4>完美世界</h4>
									<h6 style="color: gray;">科技 | 游戏</h7>
									<div>
									<br/>
									<button type="button" id="hotbtn"/>431个热招职位
									</div>
								...
								<div class="col-md-3">
									<div>
									<img src="img/yuewenjituanLogo.png" id="hotimg" />
									</div>
									<h4>阅文集团</h4>
									<h6 style="color: gray;">科技 | 读书</h7>
									<div>
									<br/>
									<button type="button" id="hotbtn"/>431个热招职位
									</div>
								...
								<div class="col-md-3">
									<div>
									<img src="img/zijietiaodongLogo.jpg" id="hotimg" />
									</div>
									<h4>字节跳动</h4>
									<h6 style="color: gray;">科技 | 短视频</h7>
									<div>
									<br/>
									<button type="button" id="hotbtn"/>1031个热招职位
									</div>
								</div>
							</div>
						</div>
