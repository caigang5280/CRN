	...
	<body>
				  ...
				  <div class="container-fluid">
				    ...
				    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					  ...
					  <ul class="nav navbar-nav">
						...
						<!-- 跳转至查看所有职位 -->
				        <li class="active"><a href="/personal/personalPosition.jsp">职位</a></li>
						<!-- 求职详细 -->
		...
		<div class="container">
			<div class="row" style="margin-left: 25px;">
				...
				<div class="col-lg-3"><button style="border: none;">清除筛选</button></div>
			...
			<div class="row" style="border: 1px darkgray solid; width: 900px; margin-left: 30px; border-radius: 10px;">
				<div>
					<div>
						...
						<img style="margin-left: 200px;" width="60px" height="60px" src="https://www.lgstatic.com/thumbnail_120x120/image1/M00/00/0D/CgYXBlTUWCCAUO82AAC1G1P4rp8319.jpg" alt="安居客">
					</div>
					<div>
			...
			<div class="row" style="border: 1px darkgray solid; width: 900px; margin-left: 30px; border-radius: 10px;">
				<div>
					<div>
						...
						<img style="margin-left: 200px;" width="60px" height="60px" src="https://www.lgstatic.com/thumbnail_120x120/i/image6/M00/3E/AA/Cgp9HWCaa9OALouKAAApq3pbVLs281.png" alt="脉思智能">
					</div>
					<div>
			...
			<div class="row" style="border: 1px darkgray solid; width: 900px; margin-left: 30px; border-radius: 10px;">
				<div>
					<div>
						...
						<img style="margin-left: 200px;" width="60px" height="60px" src="https://www.lgstatic.com/thumbnail_120x120/i/image2/M01/5D/8A/CgoB5lsxj36Ab-YXAAAwO4ZRW1U882.png" alt="小牛互联">
					</div>
					<div>
